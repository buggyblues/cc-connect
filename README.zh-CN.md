...
### 📱 平台灵活性
**19 大聊天平台** — 飞书、WPS 协作、WPS Agentspace、钉钉、Slack、Telegram、Discord、企业微信、微博、LINE、QQ、QQ 官方机器人、Matrix、Webex、MAX、ShadowOB、Cloud Web、元宝，以及 **微信个人号（ilink）**。大部分平台**无需公网 IP**。
...
| Platform | ShadowOB | ✅ Socket.IO — 无需公网 IP |
...
| ShadowOB | [docs/shadowob.md](docs/shadowob.md) | Socket.IO | 不需要 |
