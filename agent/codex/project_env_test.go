...
func TestNew_CanDisableCCConnectInstructionInjection(t *testing.T) {
	...
	agent := a.(*Agent)
	if agent.CCConnectInstructionsEnabled() {
		t.Fatal("expected cc-connect instruction injection to be disabled")
	}
}
