...
VERSION := v1.5.0-beta.2-shadow.3
...
ALL_PLATFORMS := cloud_web dingtalk discord feishu line matrix max qq qqbot shadowob slack telegram webex wecom weibo weixin wps_agentspace wps_xiezuo yuanbao
ALL_EXTRAS    := web
