...
ALL_AGENTS    := acp claudecode codex cursor devin gemini iflow kimi opencode orbit pi qoder
ALL_PLATFORMS := feishu telegram discord slack dingtalk wecom weixin qq qqbot line weibo max shadowob
ALL_EXTRAS    := web
